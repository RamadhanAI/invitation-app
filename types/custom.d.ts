...
declare module 'papaparse' {
  ...
  export interface ParseResult<T> { data: T[]; errors: ParseError[]; meta: unknown }
  ...
  export function parse<T = unknown>(input: string | File | Blob, config?: ParseConfig<T>): ParseResult<T>;
